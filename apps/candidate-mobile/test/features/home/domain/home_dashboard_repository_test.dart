...
void main() {
  group('HomeDashboard.readinessBandProgressNote', () {
    ...
    test('points toward Building while starting out', () {
      ...
      expect(dashboard.readinessBandProgressNote, '25% to Building');
    });
    ...
    test('points toward Job ready while building', () {
      ...
      expect(dashboard.readinessBandProgressNote, '13% to Job ready');
    });
    ...
    test('rounds up rather than to nearest, never claiming 0% early', () {
      ...
      expect(dashboard.readinessBandProgressNote, '1% to Job ready');
    });
    ...
    test('is null once already job ready -- nothing further to point to', () {
      ...
      expect(dashboard.readinessBandProgressNote, isNull);
    });
  });
